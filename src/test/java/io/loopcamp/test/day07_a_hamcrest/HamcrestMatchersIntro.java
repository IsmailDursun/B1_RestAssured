...
public class HamcrestMatchersIntro {
    ...
    public void stringTest () {
        ...
        assertThat(str, is(blankString()));  // blackString(); --- >  method is returning true on both " " and ""
        assertThat(str.replace(" ", ""), is(blankString()));  // blackString(); --- >  method is returning true on both " " and ""
