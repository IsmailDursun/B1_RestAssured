...
public class MinionApiWithParamsTest {
    ...
    String url = "http://3.89.9.33:8000/api/minions";
    /**
    ...
    public void getSingleMinionNotFound () {
        ...
        System.out.println("Content type: " + response.contentType());
        assertEquals("application/json", response.contentType());
        assertEquals(ContentType.JSON.toString(), response.contentType());  // This is doing the thing above | The reason we did toString() is because assertEquals compares to same data type, in this case String
